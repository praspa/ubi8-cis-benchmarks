        ...
        if do_remediate:
            ...
            if audit_passed == False:
                ...
                for remediation in control.get('remediations'):
                    ...
                    # Audit is Applicable
                    print("Remediation cmd: " + remediation.get('cmd'))
...
def createReport():
    ...
    if do_audit:
        ...
        if len(ignore_list) != 0:
            print("Controls Not Applicable - Known a priori: ",len(ignore_list))
            for control_id in ignore_list:
                print(control_id)

            print

        print("Controls Not Applicable - Derived: ",len(audit_report_na))
